      ...
      <Container sx={{ mt: 2, mb: 7, fontSize: 20 }}>
        {program.id === 26 ? (
          <p>
            ...
            utiliza nuestra aplicación móvil Mr Chancho En Escena. ¿Qué
            ...
            identificación. Además, la Aplicación puede requerir acceso a la
            cámara y la galería de su dispositivo para su funcionamiento. ¿Cómo
            utilizamos su información? Utilizamos la información que recopilamos
            para: Crear y administrar su cuenta, Proporcionarle soporte al
            cliente, Comunicarnos con usted sobre la Aplicación y cualquier
            actualización o cambio, Mejorar la Aplicación y sus características,
            Realizar investigaciones y análisis para comprender mejor cómo se
            utiliza la Aplicación, También podemos utilizar su información
            ...
            para asegurar la transmisión de datos entre su dispositivo y
            nuestros servidores. También restringimos el acceso a su información
            personal a empleados que necesitan conocer la información para
            proporcionarle los servicios ofrecidos por la Aplicación.
            ¿Divulgamos su información a terceros? No vendemos, alquilamos ni
            compartimos su información personal, ni la información que usted
            carga a la aplicación con terceros para fines comerciales o de
            marketing. Podemos divulgar su información personal a proveedores de
            servicios de terceros que nos ayudan a proporcionar los servicios
            ...
            pueden utilizarla para el propósito específico para el que se
            ...
            contactándonos por el chat interno. Tenga en cuenta que podemos
            conservar cierta información según lo requerido por la ley o para
            fines comerciales legítimos. Cambios en nuestra Política de
            privacidad: Podemos actualizar esta Política de privacidad de vez en
            cuando para reflejar cambios en nuestras prácticas o para cumplir
            con las leyes aplicables. Le notificaremos de cualquier cambio
            ...
            esta Política de privacidad, comuníquese con nosotros mediante el
            chat. Al utilizar la Aplicación, usted acepta nuestra recopilación,
