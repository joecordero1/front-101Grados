    ...
    <div>
      ...
      <Container sx={{ mt: 2, mb: 7, fontSize: 20 }}>
        <p>
          ...
          serio. Esta Política de privacidad explica cómo recopilamos, usamos y
          divulgamos su información personal cuando utiliza nuestra aplicación
          ...
          medidas razonables para proteger su información personal contra
          acceso, uso y divulgación no autorizados. Utilizamos protocolos de
          cifrado de estándar industrial para asegurar la transmisión de datos
          entre su dispositivo y nuestros servidores. También restringimos el
