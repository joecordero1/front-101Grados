        ...
        <div className="container">
          ...
          <div className="row cols-xl-8 cols-lg-6 cols-md-4 cols-sm-3 cols-2">
            ...
            <div className="category-wrap mb-4">
              ...
              >
                <ALink
                  href={{ pathname: '/shop', query: { category: 'furniture' } }}
                  scroll={false}
                >
                  <figure className="categroy-media">
            ...
            <div className="category-wrap mb-4">
              <div
                className={`category category-icon ${
                  query.category === 'sports' ? 'active' : ''
                }`}
              >
                <ALink
                  href={{ pathname: '/shop', query: { category: 'sports' } }}
                  scroll={false}
                >
                  <figure className="categroy-media">
            ...
            <div className="category-wrap mb-4">
              <div
                className={`category category-icon ${
                  query.category === 'toys' ? 'active' : ''
                }`}
              >
                <ALink
                  href={{ pathname: '/shop', query: { category: 'toys' } }}
                  scroll={false}
                >
                  <figure className="categroy-media">
            ...
            <div className="category-wrap mb-4">
              <div
                className={`category category-icon ${
                  query.category === 'cameras' ? 'active' : ''
                }`}
              >
                <ALink
                  href={{ pathname: '/shop', query: { category: 'cameras' } }}
                  scroll={false}
                >
                  <figure className="categroy-media">
            ...
            <div className="category-wrap mb-4">
              <div
                className={`category category-icon ${
                  query.category === 'gaming' ? 'active' : ''
                }`}
              >
                <ALink
                  href={{ pathname: '/shop', query: { category: 'gaming' } }}
                  scroll={false}
                >
                  <figure className="categroy-media">
            ...
            <div className="category-wrap mb-4">
              <div
                className={`category category-icon ${
                  query.category === 'headphones' ? 'active' : ''
                }`}
              >
                <ALink
                  href={{
                    pathname: '/shop',
                    query: { category: 'headphones' },
                  }}
                  scroll={false}
                >
                  <figure className="categroy-media">
            ...
            <div className="category-wrap mb-4">
              <div
                className={`category category-icon ${
                  query.category === 'smartphone' ? 'active' : ''
                }`}
              >
                <ALink
                  href={{
